    ...
    render:_=>{
        ...
        <div id="shopping-profile">
            <form id="shopping-form">
                ...
                <li>
                    <input value="${contactnumber}" required type="tel" name="contactnumber" id="contactnumber" placeholder="Contact Number"  />
                </li>
                <li>
                ...
                <li>
                    <input value="${postalcode}" required type="text" name="postalcode" placeholder="Postal code" id="postalcode"  />
                </li>
                <li>
                    <input value="${country}" required type="text" name="country" placeholder="Country" id="country"  />
                </li>
